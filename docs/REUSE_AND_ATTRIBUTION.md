...
версии, источники и SHA-256 фиксируются в `scripts/setup_local_llm.ps1` и локальном
манифесте. Собственная часть проекта — учебный workflow, JSON-контракты, BKT,
хранилище, аудит и интерфейсы студента/преподавателя.
