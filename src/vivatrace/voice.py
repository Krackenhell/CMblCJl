...
"""
    return (
        ...
        .replace(
            "__TOPIC__",
            escape(str(config.get("topic") or "Speaking practice"), quote=True),
        )
    )
