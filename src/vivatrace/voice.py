...
<div class="shell">
  ...
  <div class="controls"><button id="start" class="primary">Начать диалог</button><button id="manual" class="secondary" disabled>Начать реплику вручную</button><button id="stop" class="danger" disabled>Завершить диалог</button><div class="hint">Реплика отправится после тишины. В ручном режиме сначала нажмите кнопку, произнесите полное английское предложение, затем нажмите «Отправить реплику». Зелёная полоска должна двигаться.</div></div>
</div>
<script>
